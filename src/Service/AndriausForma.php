...
Class AndriausForma
{
    ...
    {
        return $this->entityManager->getRepository('App:models')->findAll();
    }

    public function transmitions()
    {
        return $this->entityManager->getRepository('App:transmitionTypes')->findAll();
    }

    public function fuel()
    {
        return $this->entityManager->getRepository('App:fuelTypes')->findAll();
    }
