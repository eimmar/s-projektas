...
Class AndriausForma
{
    ...
    {
        return $this->entityManager->getRepository('App:Model')->findAll();
    }

    public function transmissions()
    {
        return $this->entityManager->getRepository('App:TransmissionType')->findAll();
    }

    public function fuel()
    {
        return $this->entityManager->getRepository('App:FuelType')->findAll();
    }
